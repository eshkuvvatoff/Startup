    ...
    <div>
      <Popover>
        ...
        <PopoverContent 
          align="end" 
          sideOffset={20} 
          className="w-[calc(100vw-2rem)] sm:w-80 py-5 px-2 backdrop-blur-md border-b-2 border-border/40 bg-brand-indigo/20 dark:bg-brand-indigo/10 rounded-xl animate-in fade-in zoom-in-95 duration-200 shadow-[0_15px_30px_-10px_rgba(58,12,163,0.5),0_10px_10px_-15px_rgba(0,0,0,0.6)]"
        >
