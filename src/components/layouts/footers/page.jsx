...
export default function Footer() {
  ...
  return (
    <footer className=" w-full bg-brand-indigo/25 dark:bg-brand-indigo/10 backdrop-blur-md border-t border-white/10 px-6 py-10 md:px-8 md:py-6 shadow-[0_-15px_30px_-10px_rgba(58,12,163,0.5),0_-2px_10px_-5px_rgba(0,0,0,0.6)]">
